 ...
 * adapted for #ck2016 by Hella Schuster
 */
...
body {
  background: #DE7C1D;
  background: -moz-radial-gradient(center, circle cover, #f7fbfc 0%, #DE7C1D 100%);
  background: -webkit-gradient(radial, center center, 0px, center center, 100%, color-stop(0%, #f7fbfc), color-stop(100%, #DE7C1D));
  background: -webkit-radial-gradient(center, circle cover, #f7fbfc 0%, #DE7C1D 100%);
  background: -o-radial-gradient(center, circle cover, #f7fbfc 0%, #DE7C1D 100%);
  background: -ms-radial-gradient(center, circle cover, #f7fbfc 0%, #DE7C1D 100%);
  background: radial-gradient(center, circle cover, #f7fbfc 0%, #DE7C1D 100%);
...
.reveal .controls .navigate-left.enabled:hover {
  border-right-color: #de7c1d; }

.reveal .controls .navigate-right.enabled:hover {
  border-left-color: #de7c1d; }

.reveal .controls .navigate-up.enabled:hover {
  border-bottom-color: #de7c1d; }

.reveal .controls .navigate-down.enabled:hover {
  border-top-color: #de7c1d; }
